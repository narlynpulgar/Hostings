        ...
        <section class="hero bg-image" >
            <div class="hero-inner">
                ...
                <div class="container text-center hero-text font-white">
                    <div class="fronts">
                        <div class="frontss">
                        <h1>Quail Online<br> Reservation</h1>
                        <h4 style="padding-left: 154px;"><span >Best pugo in town. </span></h4></div>
                    <img class="front" src="images/img/front.png" alt="Quial" >
                    </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>The Best pugo in town</h2>
                    <p class="lead">Mas masarap ang fresh</p>
                </div>
                <div class="row-product">
						<?php 					
						$query_res= mysqli_query($db,"select * from livestock LIMIT 6"); 
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    <h5><a href="pro_duct.php?res_id='.$r['rs_id'].'">'.$r['title'].'</a></h5>
                                                    <div class="product-name">'.$r['stock
'].'</div>
                                                    <div class="price-btn-block"> <span class="price">'.$r['price'].'</span> <a href="pro_duct.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">ORDER NOW</a> </div>
                                                </div>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We've got you covered with Fresh meat & eggs choices.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Check out</h3>
                                <p>We don't accept online payment.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Pick up</h3>
                                <p>Not arriving with in 24hrs. after checkout will automatically disregard your reservation.</p>
                            </div>
                        </div>
                    </div>
                </div>
