					 ...
					 <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Update Walkin</h4>
                            </div>
                            <div class="card-body">
							  <?php $ssql ="select * from walkin_orders where w_id='$_GET[walkin_upd]'";
                                ...
                                <form action='' method='post'  >
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="quantity" class="form-control" placeholder="doe"  value="<?php  echo $newrow['quantity']; ?>">
                                                   </div>
                                            </div>
                                    ...
                                    <input  type="submit" name="submit" class="btn btn-primary" value="Save">
                                        ...
                                        <a href="Walkin_orders.php" class="btn btn-inverse">Back</a>
                                    </div>
                                </form>
                            </div>
                        </div>
