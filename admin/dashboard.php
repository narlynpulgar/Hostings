    ...
    <div id="main-wrapper">
        ...
        <div class="header">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-collapse" style="height: 10px;">
        ...
        <div class="page-wrapper">
            ...
            <div class="col-lg-12">
                    ...
                    <div class="col-md-3"><a href="all_menu.php">
                        <div class="card p-30"style="margin-top: 25px;">
                            <div class="media">
                                ...
                                <div class="media-body media-text-right">
                                    <h2><?php $sql="select * from pro_duct";
                    ...
                    <div  class="col-md-3"><a href="all_users.php">
                        <div class="card p-30"style="margin-top: 25px;">
                            <div class="media">
                                <div class="media-left meida media-middle">
					...
					<div class="col-md-3"><a href= "all_orders.php">
                        <div class="card p-30"style="margin-top: 25px;">
                            <div class="media">
                                <div class="media-left meida media-middle"> 
