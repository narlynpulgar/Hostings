...
string = 'E';
 ...
 for (pos = 0; pos <= 180; pos += 1) { // goes from 180 degrees to 0 degrees
   ...
   digitalWrite(D8, HIGH); SendMessagee();
  Sending_To_phpmyadmindatabase() ;  //CONNECTING WITH MYSQL
...
string = 'L';
 ...
 for (pos = 0; pos <= 180; pos += 1) { // goes from 180 degrees to 0 degrees
   ...
   delay(4000);
    ...
    digitalWrite(D8, HIGH);  SendMessagel();
  Sending_To_phpmyadmindatabase() ;  //CONNECTING WITH MYSQL
 }}
   if  (buttonState == HIGH) {
    if (buttonpress == 0){
 ...
 for (pos = 0; pos <= 180; pos += 1) { // goes from 180 degrees to 0 degrees
  ...
  digitalWrite(D7, HIGH);
    ...
    while(distance_cm >= 13 && distance_cm <= 16)
    {  digitalWrite(D8, HIGH); 
     delay(1000);
      digitalWrite(D8, HIGH); 
      delay (1000);}
 ...
 void SendMessagen()
{
  ...
  delay(1000);
  Serial.println ("Set SMS Content none");
  SIM900A.println("EMPTY please refill");// Messsage content
  delay(100);
 ...
 void SendMessagel()
{
  ...
  SIM900A.println("low storage");// Messsage content
  delay(100);
  Serial.println ("Finish");
  SIM900A.println((char)26);// ASCII code of CTRL+Z
  delay(1000);
 ...
 void SendMessagee()
{
  ...
  SIM900A.println("enough");// Messsage content
  delay(100);
  Serial.println ("Finish");
  SIM900A.println((char)26);// ASCII code of CTRL+Z
  delay(1000);
 ...
 void SendMessagef()
{
  ...
  SIM900A.println("FULL");// Messsage content
  delay(100);
  Serial.println ("Finish");
  SIM900A.println((char)26);// ASCII code of CTRL+Z
  delay(1000);
 ...
 void SendMessagey()
{
  ...
  SIM900A.println("empty!");
  SIM900A.println("empty!");// Messsage content
  delay(100);
  Serial.println ("Finish");
  SIM900A.println((char)26);// ASCII code of CTRL+Z
  delay(1000);
