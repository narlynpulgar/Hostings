...
mysqli_query($db,$sql);
 if($status == "closed")
 {
  $sql="SELECT users_orders.*, pro_duct.* FROM users_orders INNER JOIN pro_duct ON users_orders.d_id=pro_duct.d_id where o_id='".$_GET['form_id']."'";
 ...
 = pro_duct.stock
 - users_orders.quantity where pro_duct.d_id = '$titles' and o_id='".$_GET['form_id']."';");
...
<table  border="0" cellspacing="0" cellpadding="0">
     <tr >
      ...
      <td><b style="font-weight:600;"><?php echo htmlentities($_GET['form_id']); ?></b></td>
    </tr>
	<tr>
      <td  >&nbsp;</td>
    ...
    <tr >
      <td><b>Status</b></td>
      <td><select  style="width:100%; height: 60px; text-align-last: center; color: white; font-size: large; background-color: #785211a1; border-color: transparent; border-radius: 10px " name="status" required="required" >
