            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">LiveStocks</span></a>
...
<div class="page-wrapper">
    <div class="container-fluid">
       <div class="row">
                 ...
                 <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">All LiveStock</h4>
                            </div>
            ...
            <?php
				$sql="SELECT * FROM LiveStock order by rs_id desc";
				$query=mysqli_query($db,$sql);
												
					if(!mysqli_num_rows($query) > 0 )
				{
					echo '<td colspan="11"><center>No LiveStocks</center></td>';
				}
					else
                {				
					while($rows=mysqli_fetch_array($query))
				{
                    ...
                    $row=mysqli_fetch_array($res);
                        echo ' <tr><td>'.$row['c_name'].'</td>
								...
								<center><img src="pro_img/'.$rows['image'].'" class="img-responsive radius"  style="min-width:150px;min-height:100px;max-height:200px;"/></center>
								</div></td> 
								<td>'.$rows['date'].'</td>
								<td><a href="delete_LiveStock.php?res_del='.$rows['rs_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
								<a href="update_LiveStock.php?res_upd='.$rows['rs_id'].'" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="fa fa-edit"></i></a>
								</td></tr>';
				}	
				}
            ?>
