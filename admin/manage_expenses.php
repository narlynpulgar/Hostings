...
if(isset($_POST['addexpense']))
{
    ...
    $sql = "INSERT INTO expense(Category,Cost, Item) VALUE('".$_POST['Category']."','".$_POST['Cost']."','".$_POST['Item']."')";  // store the submited data ino the database :images
    mysqli_query($db, $sql); 
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#AddSupplies" style="margin-bottom: 10px; margin-left: 85%;">
  Add Expenses
</button>

<!-- Modal -->
<div class="modal fade" id="AddSupplies" tabindex="-1" role="dialog" aria-labelledby="AddSuppliesLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="AddSuppliesLabel" style="font-size: 20px; font-weight: bold;">Add Expenses</h5>
      </div>
      <div class="modal-body">
        <form id="myForm" action="" method="POST">
            <div class="input-group mb-3">
                <label class="input-group-text" for="inputGroupSelect01" required="true">Category</label>
                    <select class="form-select" name="Category" id="inputGroupSelect01" required="true" style="width: 79%;">
            ...
            <div class="input-group mb3">
                <span class="input-group-text" id="addon-wrapping" style="width: 20%;">Item</span>
                <input  class="form-control" name="Item" required="true"  style="width: 50%;">
            </div>

            <div class="input-group mb3">
                <span class="input-group-text" id="addon-wrapping" style="width: 20%; margin-top: 15px;">Cost</span>
                <input type="numeric" class="form-control" min="0" name="Cost" required="true" style="width: 50%; margin-top: 15px;">
            </div>

            <div class="input-group mb3">
                <span class="input-group-text" id="addon-wrapping" style="width: 20%; margin-top: 15px; margin-bottom: 15px;">Date</span>
                <input type="date" id="Date" name="Date" required="true" style="width: 79%; margin-top: 15px; margin-bottom: 15px;">
            </div>

        <!-----modal footer-->
        <div class="modal-footer">					
        <input type="submit" name="addexpense" class="btn btn-primary" value="Save"> 
                <a type="button" class="btn cancel" href="manage_expenses.php" style="border: solid;">Close</a>
        </div>  
...
function closeForm() {
 ...
 <?php
	...
	{
		$mql="SELECT * FROM expense where ID='".$rows['ID']."'";
        ...
        echo ' <tr><td>'.$rows['ID'].'</td>
				...
				<td>'.$rows['Cost'].'</td>
				<td>'.$rows['Date'].'</td>
				<td><a href="delete_expenses.php?exp_del='.$rows['ID'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
				</td></tr>';		
	}	
	}	
?>
