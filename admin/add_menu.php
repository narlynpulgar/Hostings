...
{
	if(empty($_POST['d_name'])||empty($_POST['stock'])||$_POST['price']=='')
		{	
				$error = 	'<div class="alert alert-danger alert-dismissible fade show">
					...
					{
						$sql = "INSERT INTO pro_duct (d_id,rs_id,title,stock,price) VALUE ('','".$_POST['res_name']."','".$_POST['d_name']."','".$_POST['stock']."','".$_POST['price']."')";  // store the submited data ino the database :images
    					mysqli_query($db, $sql); 
                        ...
                        <?php  echo $error;
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-danger">
                                    ...
                                    <input type="number" name="stock" min="1" class="form-control form-control-danger" >
                                </div>
                            </div>
