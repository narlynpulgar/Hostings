...
<div class="modal fade" id="update_modal<?php echo $r['ca_id']?>" aria-hidden="true">
	<div class="modal-dialog">
		<div style="    width: max-content;"class="modal-content">
			<form method="POST" action="dead_query.php">
				<div class="modal-header">
					<h3 class="modal-title">Add Mortality</h3>
				</div>
				<div class="modal-body">
					...
					<div class="col-md-8">
						<div class="form-group">
							...
							<input type="number" name="deads" value="0" class="form-control" required="required"/>
						</div>
